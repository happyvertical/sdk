...
export declare class ProfileRelationship extends SmrtObject {
    fromProfileId: import('../../../../core/smrt/src').Field;
    toProfileId: import('../../../../core/smrt/src').Field;
    typeId: import('../../../../core/smrt/src').Field;
    contextProfileId: import('../../../../core/smrt/src').Field;
    terms: import('../../../../core/smrt/src').Field;
