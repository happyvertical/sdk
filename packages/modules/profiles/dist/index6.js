...
var _ProfileRelationship_decorators, _init, _a;
import { SmrtObject, foreignKey, oneToMany, smrt } from "@have/smrt";
_ProfileRelationship_decorators = [smrt({
  api: { include: ["list", "get", "create", "delete"] },
  mcp: { include: ["list", "get"] },
  cli: true
})];
class ProfileRelationship extends (_a = SmrtObject) {
  ...
  async addTerm(startedAt, endedAt) {
    const { ProfileRelationshipTermCollection } = await import("./index15.js");
...
ProfileRelationship = __decorateElement(_init, 0, "ProfileRelationship", _ProfileRelationship_decorators, ProfileRelationship);
__runInitializers(_init, 1, ProfileRelationship);
export {
  ProfileRelationship
};
