...
var _ProfileRelationshipTerm_decorators, _init, _a;
import { SmrtObject, foreignKey, datetime, smrt } from "@have/smrt";
_ProfileRelationshipTerm_decorators = [smrt({
  api: { include: ["list", "get", "create", "update", "delete"] },
  mcp: { include: ["list", "get"] },
  cli: true
})];
class ProfileRelationshipTerm extends (_a = SmrtObject) {
...
ProfileRelationshipTerm = __decorateElement(_init, 0, "ProfileRelationshipTerm", _ProfileRelationshipTerm_decorators, ProfileRelationshipTerm);
__runInitializers(_init, 1, ProfileRelationshipTerm);
export {
