...
var _ProfileMetadata_decorators, _init, _a;
import { SmrtObject, foreignKey, text, smrt } from "@have/smrt";
_ProfileMetadata_decorators = [smrt({
  api: { include: ["list", "get", "create", "update", "delete"] },
  mcp: { include: ["list", "get"] },
  cli: true
})];
class ProfileMetadata extends (_a = SmrtObject) {
...
ProfileMetadata = __decorateElement(_init, 0, "ProfileMetadata", _ProfileMetadata_decorators, ProfileMetadata);
__runInitializers(_init, 1, ProfileMetadata);
export {
  ProfileMetadata
};
