...
var _Product_decorators, _init, _a;
...
class Product extends (_a = SmrtObject) {
  name = "";
  description = "";
  category = "";
...
Product = __decorateElement(_init, 0, "Product", _Product_decorators, Product);
__runInitializers(_init, 1, Product);
export {
  Product
};
