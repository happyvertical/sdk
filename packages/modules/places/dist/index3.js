...
var _PlaceType_decorators, _init, _a;
...
class PlaceType extends (_a = SmrtObject) {
...
PlaceType = __decorateElement(_init, 0, "PlaceType", _PlaceType_decorators, PlaceType);
__runInitializers(_init, 1, PlaceType);
export {
  PlaceType
};
