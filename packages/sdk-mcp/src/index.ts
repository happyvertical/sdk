    ...
    this.server.setRequestHandler(ListToolsRequestSchema, async () => ({
      tools: [
          ...
          inputSchema: {
            ...
            properties: {
              ...
              packages: {
                ...
                items: { type: 'string' },
                description:
                  'Optional: Specific packages to consult (e.g., ["ai", "sql"])',
              },
            },
            required: ['query'],
          },
        },
        {
          name: 'list-packages',
          description:
            'List all available SDK packages with their descriptions and keywords',
          inputSchema: {
            type: 'object',
            properties: {},
          },
          ...
          inputSchema: {
            ...
            properties: {
              packageName: {
                type: 'string',
                description:
                  'Name of the package (e.g., "ai", "sql", "spider")',
              },
            },
