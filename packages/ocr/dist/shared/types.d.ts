...
export declare class OCRError extends Error {
    ...
    constructor(message: string, provider?: string | undefined, context?: any | undefined);
}
export declare class OCRDependencyError extends OCRError {
    constructor(provider: string, message: string, context?: any);
}
export declare class OCRUnsupportedError extends OCRError {
    constructor(provider: string, operation: string, context?: any);
}
export declare class OCRProcessingError extends OCRError {
    constructor(provider: string, message: string, context?: any);
}
/**
