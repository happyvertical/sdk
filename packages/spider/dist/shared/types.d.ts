 ...
 */
export type SpiderAdapterOptions = SimpleAdapterOptions | DomAdapterOptions | CrawleeAdapterOptions;
/**
 ...
 */
export type ScraperType = 'basic' | 'tree' | 'ajax' | 'scroll' | 'pagination' | 'tabs' | 'hybrid';
/**
 ...
 */
export type ScraperOptions = BasicScraperOptions | TreeScraperOptions | AjaxScraperOptions | ScrollScraperOptions | PaginationScraperOptions;
