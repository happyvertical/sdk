...
export async function generateSvelteKitRoutes(
  ...
  await generateSmrtConfigFile(projectRoot, options);
...
function getSvelteKitImportPath(
  ...
  const relativePath = relative(absoluteObjectsDir, objectFilePath);
...
import '${importPath}'; // Import to trigger @smrt() decorator
`;
