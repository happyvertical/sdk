import { OCRImage as BaseOCRImage, DependencyCheckResult, OCROptions, OCRResult } from '../../../ocr/src';
/**
...
export type { OCROptions } from '../../../ocr/src';
/**
...
export type { OCRResult } from '../../../ocr/src';
/**
...
export type { DependencyCheckResult, OCRFactoryOptions, OCRProvider, } from '../../../ocr/src';
/**
...
export interface PDFReader {
     ...
     * ```
     */
    extractText(source: string | ArrayBuffer | Uint8Array, options?: ExtractTextOptions): Promise<string | null>;
    /**
...
export declare class PDFUnsupportedError extends PDFError {
    constructor(operation: string);
}
export declare class PDFDependencyError extends PDFError {
