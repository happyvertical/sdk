 ...
 * ```
 */
export declare function foreignKey(relatedClass: any, options?: Omit<RelationshipFieldOptions, 'related'>): Field;
/**
 ...
 * ```
 */
export declare function oneToMany(relatedClass: any, options?: Omit<RelationshipFieldOptions, 'related'>): Field;
/**
 ...
 * ```
 */
export declare function manyToMany(relatedClass: any, options?: Omit<RelationshipFieldOptions, 'related'>): Field;
