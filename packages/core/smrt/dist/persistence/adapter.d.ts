...
import { AdapterMetadata, CountOptions, ListOptions, LoadFilter, SaveResult } from './types';
/**
 ...
 */
export type AdapterFactory = (config: any, objectClass: new (...args: any[]) => SmrtObject) => Promise<PersistenceAdapter>;
