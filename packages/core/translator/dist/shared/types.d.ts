...
export interface ITranslator extends ITranslationProvider {
     ...
     */
    templateFunction(sourceLanguage?: string, targetLanguage?: string): (text: string) => Promise<string>;
}
/**
 ...
 */
export type TranslatorOptions = GoogleTranslateOptions | DeepLOptions | LibreTranslateOptions;
/**
 ...
 */
export declare class UnsupportedLanguageError extends TranslationError {
    constructor(language: string, provider?: string);
}
/**
 * Quota exceeded error
 */
export declare class QuotaExceededError extends TranslationError {
    constructor(provider?: string);
}
/**
 * API authentication error
 */
export declare class AuthenticationError extends TranslationError {
    constructor(provider?: string);
}
/**
 * Invalid text error
 */
export declare class InvalidTextError extends TranslationError {
