...
import { type CreateDirOptions, type FileInfo, type FileStats, type FilesystemCapabilities, type ListOptions, type LocalOptions, type ReadOptions, type WriteOptions } from '../shared/types';
/**
