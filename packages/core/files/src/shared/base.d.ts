import { type BaseProviderOptions, type CacheOptions, type CreateDirOptions, type DownloadOptions, type FileInfo, type FileStats, type FilesystemCapabilities, type FilesystemInterface, type ListFilesOptions, type ListOptions, type ReadOptions, type UploadOptions, type WriteOptions } from './types';
/**
