import { OCRDependencyError, OCRError } from "./index3.js";
...
class OCRFactory {
  ...
  async initializeProviders() {
    ...
    try {
      try {
        const { TesseractProvider } = await import("./index4.js");
        this.providers.set("tesseract", new TesseractProvider());
      } catch {
      }
      if (this.environment === "node") {
        try {
          const { ONNXGutenyeProvider } = await import("./index5.js");
          this.providers.set("onnx", new ONNXGutenyeProvider());
        } catch {
        }
      } else if (this.environment === "browser") {
        try {
          const { WebOCRProvider } = await import("./index6.js");
