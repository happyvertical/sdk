import Ocr from "./index7.js";
import jpeg from "./index8.js";
import { p as pngExports } from "./index9.js";
import { OCRDependencyError } from "./index3.js";
  ...
  decodeImageToRGB(imageBuffer) {
    try {
      if (imageBuffer.subarray(0, 8).equals(Buffer.from([137, 80, 78, 71, 13, 10, 26, 10]))) {
        ...
        const png = pngExports.PNG.sync.read(imageBuffer);
