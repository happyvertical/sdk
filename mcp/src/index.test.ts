...
describe('MCP Server Components', () => {
  describe('Resources', () => {
    ...
    it('should list all available resources', () => {
      ...
      expect(resourceNames).toContain('smrt://docs/core/base-object');
    ...
    it('should read core documentation', async () => {
      const content = await resources.read('smrt://docs/core/base-object');
  ...
  describe('Tools', () => {
    ...
    it('should generate SMRT class with basic fields', async () => {
      ...
      expect(result).toContain('class TestProduct extends BaseObject');
    ...
    it('should validate SMRT object code', async () => {
      const validCode = `
        import { BaseObject, smrt, text } from '@have/smrt';
