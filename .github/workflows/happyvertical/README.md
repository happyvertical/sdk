...
```bash
bun scripts/standardize-repo.ts --repo happyvertical/sdk --path . --description "TypeScript SDK for building vertical AI agents" --areas "core,ai,database,files,documentation"
```
