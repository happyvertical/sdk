...
Add new @happyvertical/auth package providing a unified authentication interface for multiple providers.
...
- Environment variable configuration (HAVE_AUTH_* prefix)
